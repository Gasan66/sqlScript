...
left join AuctionCycles AC on ProtocolCzoItems.AuctionCycleId = AC.Id
...
FROM
PR_RH_AC
join PR_2020 on PR_2020.Id = PR_RH_AC.RequestId
LEFT JOIN [dbo].[ProtocolCzoItems] AS PCi ON PR_RH_AC.AuctionCycleId = PCi.AuctionCycleId
LEFT JOIN [dbo].[ProtocolCzoes] AS PC ON PC.Id = PCi.Protocol_Id AND PC.[Status] IN ( 3
                                                                                    ,1  --"На согласовании"
																					,4  --"Согласовано"
																					,2) --"Завершен"
																AND PCi.IsApproved = 1  --"Согласовано" = "Да"
